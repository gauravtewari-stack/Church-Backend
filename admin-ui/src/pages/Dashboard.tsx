...
import { Mic, Heart, Image as ImageIcon, ArrowRight } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const activeCampaigns = state.donations.filter((d) => d.status === 'active').slice(0, 3);
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '8px' }}>
                      ...
                      <span
                        style={{
                          ...
                          fontSize: '12px',
                          fontWeight: 500,
                          backgroundColor: sermon.status === 'active' ? '#dffcf0' : '#f3f4f6',
                          color: sermon.status === 'active' ? '#065f46' : '#374151',
                        }}
                      >
                        {sermon.status}
                      </span>
